...
<!-- NOTE: ratul-hasan-ruhan.md at the repo root is a copy of this file that the
     live site serves to agents (Vercel does not serve README.md). Keep both in
     sync — `cp README.md ratul-hasan-ruhan.md` after editing. -->
